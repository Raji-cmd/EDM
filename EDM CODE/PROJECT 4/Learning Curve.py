...
# Read each sheet
su_data = pd.read_excel("EDM4.xlsx", sheet_name="Surface Waviness SW")
svr_data = pd.read_excel("EDM4.xlsx", sheet_name="Material Vaporization Rate MVR")
kc_data  = pd.read_excel("EDM4.xlsx", sheet_name="Kerf Distance KD")

plot_learning_curve(su_data, "SW", "Mean Squared Error")
plot_learning_curve(svr_data, "MVR", "Mean Squared Error")
plot_learning_curve(kc_data, "KD", "Mean Squared Error")
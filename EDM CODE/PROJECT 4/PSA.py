...
data = {
    ...
    "SW": [4.174, 3.775, 2.457, 3.778, 4.174, 3.775, 2.716, 3.080, 3.530, 3.868,
...
ax.set_title('SW', fontsize=16, fontweight='bold')
ax.grid(True, linestyle='--', alpha=0.3)
bold_axes(ax)
cbar = plt.colorbar(scatter)
cbar.set_label('SW', fontsize=11, fontweight='bold')
plt.tight_layout()
plt.show()
...
ax.set_title('KD', fontsize=16, fontweight='bold')
ax.grid(True, linestyle='--', alpha=0.3)
bold_axes(ax)
cbar = plt.colorbar(scatter)
cbar.set_label('KD', fontsize=12, fontweight='bold')
plt.tight_layout()
plt.show()

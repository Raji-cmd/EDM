...
draw_network(layers_sw, colors, "Neural Network Architecture: Surface Undulation")
draw_network(layers_mer, colors, "Neural Network Architecture: Substance Vaporization Rate")
draw_network(layers_kg, colors, "Neural Network Architecture: Kerf Clearence ")

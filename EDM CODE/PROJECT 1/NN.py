...
draw_network(layers_sw, colors, "Neural Network Architecture: Surface Roughness")
draw_network(layers_mer, colors, "Neural Network Architecture: Material Removal rate")
draw_network(layers_kg, colors, "Neural Network Architecture: Kerf Width")

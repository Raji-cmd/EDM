...
ax.set_title('ESR', fontsize=16, fontweight='bold')
ax.grid(True, linestyle='--', alpha=0.3)
bold_axes(ax)
cbar = plt.colorbar(scatter)
cbar.set_label('ESR', fontsize=11, fontweight='bold')
plt.tight_layout()
plt.show()
...
ax.set_title('KG', fontsize=16, fontweight='bold')
ax.grid(True, linestyle='--', alpha=0.3)
bold_axes(ax)
cbar = plt.colorbar(scatter)
cbar.set_label('KG', fontsize=12, fontweight='bold')
plt.tight_layout()
plt.show()
